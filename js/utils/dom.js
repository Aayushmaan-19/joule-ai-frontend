...
export const eyePupil =
  document.getElementById("eyePupil");
...
export const authToggleBtn =
  document.getElementById("authToggleBtn");

export const authToggleText =
...
export const otpInputs =
  document.getElementById("otpInputs");
...
export const otpResendBtn =
  document.getElementById("otpResendBtn");

export const otpEmailDisplay =
...
export const profilePreviewImg =
  document.getElementById("profilePreviewImg");
